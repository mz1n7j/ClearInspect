    ...
    <div style={{...mOv,alignItems:"center",padding:16}} onClick={onClose}>
      <div style={{...mBox,borderRadius:16,maxWidth:420,animation:"fadeIn 0.2s ease"}} onClick={e=>e.stopPropagation()}>
        <div style={{display:"flex",justifyContent:"center",marginBottom:14}}>
          <span style={{width:52,height:52,borderRadius:14,background:"#fbfbf8",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 16px rgba(0,0,0,0.4)"}}><img src="/inspectortrust-mark.png" alt="InspectorTrust" width="42" height="42" style={{display:"block"}}/></span>
        </div>
    ...
    <div style={{borderTop:`1px solid #1a1a1a`,marginTop:60,padding:"20px 24px"}}>
      <div style={{maxWidth:960,margin:"0 auto"}}>
        <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:14}}>
          <span style={{width:26,height:26,borderRadius:6,background:"#fbfbf8",display:"flex",alignItems:"center",justifyContent:"center"}}><img src="/inspectortrust-mark.png" alt="InspectorTrust" width="21" height="21" style={{display:"block"}}/></span>
          <span style={{fontSize:13,fontWeight:700,color:"#555",letterSpacing:"-0.01em"}}>Inspector<span style={{color:"#7a6a32"}}>Trust</span></span>
        </div>
        ...
        <div style={card}>
          ...
          <div style={{background:"#fff",borderRadius:10,padding:"22px 20px",maxHeight:560,overflowY:"auto"}}>
            <div style={{fontFamily:"Arial,Helvetica,sans-serif",maxWidth:520,margin:"0 auto",color:"#1a1a1a"}}>
              ...
              <div style={{marginBottom:18}}><img src="/inspectortrust-logo.png" alt="InspectorTrust" width="120" style={{display:"block"}}/></div>
    ...
    <div style={{minHeight:"100vh",background:C.base,color:C.text,fontFamily:"'DM Sans',system-ui,sans-serif"}}>
      ...
      <header style={{position:"sticky",top:0,zIndex:100,background:"rgba(14,14,14,0.96)",borderBottom:`1px solid ${C.border}`,backdropFilter:"blur(10px)"}}>
        <div style={{maxWidth:960,margin:"0 auto",padding:"0 16px",height:56,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          <button onClick={()=>navTo("home")} style={{display:"flex",alignItems:"center",gap:9,background:"none",border:"none",cursor:"pointer",fontFamily:"inherit",padding:0}}>
            <span style={{width:32,height:32,borderRadius:8,background:"#fbfbf8",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 1px 4px rgba(0,0,0,0.45)",flexShrink:0}}><img src="/inspectortrust-mark.png" alt="InspectorTrust" width="26" height="26" style={{display:"block"}}/></span>
            <span style={{fontSize:16,fontWeight:800,letterSpacing:"-0.01em",color:C.text}}>Inspector<span style={{color:C.gold}}>Trust</span></span>
          </button>
      ...
      {view==="home"&&<main style={{maxWidth:960,margin:"0 auto",padding:"0 16px 80px"}}>
        <div style={{textAlign:"center",padding:"40px 0 28px"}}>
          <div style={{display:"flex",justifyContent:"center",marginBottom:20}}>
            <span style={{width:96,height:96,borderRadius:24,background:"#fbfbf8",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 10px 34px rgba(0,0,0,0.5)"}}><img src="/inspectortrust-mark.png" alt="InspectorTrust" width="76" height="76" style={{display:"block"}}/></span>
          </div>
