...
const CONTACT_EMAIL = "inspectortrustfeedback@gmail.com";
    ...
    <div style={{...mOv,alignItems:"center",padding:16}} onClick={onClose}>
      <div style={{...mBox,borderRadius:16,maxWidth:420,animation:"fadeIn 0.2s ease"}} onClick={e=>e.stopPropagation()}>
        <div style={{display:"flex",justifyContent:"center",marginBottom:16}}>
          <img src="/inspectortrust-logo-dark.png" alt="InspectorTrust" style={{height:74,display:"block"}}/>
        </div>
    ...
    <div style={{borderTop:`1px solid #1a1a1a`,marginTop:60,padding:"20px 24px"}}>
      <div style={{maxWidth:960,margin:"0 auto"}}>
        <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:14,flexWrap:"wrap"}}>
          <img src="/inspectortrust-mark.png" alt="InspectorTrust" width="24" height="24" style={{display:"block"}}/>
          <span style={{fontSize:13,fontWeight:700,color:"#666",letterSpacing:"-0.01em"}}>Inspector<span style={{color:"#9c853f"}}>Trust</span></span>
          <span style={{color:"#333",fontSize:12,marginLeft:4}}>·</span>
          <a href={`mailto:${CONTACT_EMAIL}`} style={{color:"#6a6a6a",fontSize:12,textDecoration:"none"}}>Questions or feedback? {CONTACT_EMAIL}</a>
        </div>
...
function TermsPage() {
  const sections=[
    ...
    ["18. Contact",`Questions about these Terms or the Service may be sent to ${CONTACT_EMAIL}.`],
  ];
  return (
...
function AdminOutreachView({session, showToast}) {
  ...
  const [replyTo,setReplyTo]=useState(isAdmin?CONTACT_EMAIL:(session?.profile?.email||""));
      ...
      <header style={{position:"sticky",top:0,zIndex:100,background:"rgba(14,14,14,0.96)",borderBottom:`1px solid ${C.border}`,backdropFilter:"blur(10px)"}}>
        <div style={{maxWidth:960,margin:"0 auto",padding:"0 16px",height:56,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          <button onClick={()=>navTo("home")} style={{display:"flex",alignItems:"center",gap:9,background:"none",border:"none",cursor:"pointer",fontFamily:"inherit",padding:0}}>
            <img src="/inspectortrust-mark.png" alt="InspectorTrust" width="32" height="32" style={{display:"block"}}/>
      ...
      {view==="home"&&<main style={{maxWidth:960,margin:"0 auto",padding:"0 16px 80px"}}>
        <div style={{textAlign:"center",padding:"40px 0 28px"}}>
          <div style={{display:"flex",justifyContent:"center",marginBottom:24}}>
            <img src="/inspectortrust-logo-dark.png" alt="InspectorTrust" style={{height:150,display:"block"}}/>
          </div>
