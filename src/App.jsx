...
function TermsPage() {
  const sections=[
    ...
    ["13. Arbitration and Class-Action Waiver","Any dispute arising out of or relating to these Terms or the Service shall be resolved by binding individual arbitration. You and the operator each waive any right to a jury trial and to participate in any class, collective, or representative action."],
